...
def compress(
    ...
    Args:
        ...
        save_as (Literal['img', 'anim'], optional): Compression format. Defaults to 'img'.
...
class ImageQuadTree:
    ...
    def __init__(
        ...
        root.leaf_level = max(root.leaf_level, level)
    ...
    def save_image(
        ...
        axes.imshow(self.get_square(level, boundaries), aspect='equal')
